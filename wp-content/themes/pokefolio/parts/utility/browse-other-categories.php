<section class="--bgdark heading--white">
    <h2 class="--centralizer">Browse more categories</h2>
</section>
<!-- BROWSE CATEGORIES -->
...
foreach($categories as $category) {
    ...
    <section class="category section-<?php if($section_odd_or_even % 2 == 0): echo 'even'; else: echo 'odd'; endif; ?>">
        <div class="wrapper">
        <div class="heading" data-aos="fade-<?php if($section_odd_or_even % 2 == 0): echo 'left'; else: echo 'right'; endif; ?>" data-aos-duration="1200">
